...
import com.spring.cloud.advertising.service.impl.SchedualServicePointRuleImpl;
import org.springframework.cloud.netflix.feign.FeignClient;
import org.springframework.web.bind.annotation.PathVariable;
import org.springframework.web.bind.annotation.RequestMapping;
import org.springframework.web.bind.annotation.RequestMethod;

@FeignClient(value = "SERVICE-ADVERTISING",fallback = SchedualServicePointRuleImpl.class)
public interface SchedualServicePointRule {
    String url = "/admin/pointrule";
