...
import com.spring.cloud.advertising.service.impl.SchedualServiceCommercialImpl;
import org.springframework.cloud.netflix.feign.FeignClient;
import org.springframework.web.bind.annotation.PathVariable;
import org.springframework.web.bind.annotation.RequestMapping;
import org.springframework.web.bind.annotation.RequestMethod;

@FeignClient(value = "SERVICE-ADVERTISING",fallback = SchedualServiceCommercialImpl.class)
public interface SchedualServiceCommercial {
    String url = "/admin/commercial";
