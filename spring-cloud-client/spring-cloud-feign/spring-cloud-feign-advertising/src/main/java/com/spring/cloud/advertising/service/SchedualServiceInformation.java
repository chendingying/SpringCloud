...
import com.spring.cloud.advertising.service.impl.SchedualServiceInformationImpl;
import org.springframework.cloud.netflix.feign.FeignClient;
import org.springframework.web.bind.annotation.PathVariable;
import org.springframework.web.bind.annotation.RequestMapping;
import org.springframework.web.bind.annotation.RequestMethod;

@FeignClient(value = "SERVICE-ADVERTISING",fallback = SchedualServiceInformationImpl.class)
public interface SchedualServiceInformation {
    String url = "/admin/information";
