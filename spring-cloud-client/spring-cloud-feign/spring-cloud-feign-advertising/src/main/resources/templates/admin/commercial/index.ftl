...
<script>
        ...
        $("#table_list").bootstrapTable({
            ...
            columns: [{
                ...
                formatter: function(value,row,index){
                    if(value == 0)
                        return '<span class="label label-info">资讯</span>';
                    else if(value == 1)
                        return '<span class="label label-primary">新闻</span>';
                    else if(value == 2)
                        return '<span class="label label-primary">人物</span>';
                    else if(value == 3)
                        return '<span class="label label-primary">学堂</span>';
                }
            },{
                title: "网站logo",
                field: "picture"
    ...
    function edit(id){
        layer.open({
            ...
            shade: false,
            area: ['693px', '450px'],
            content: '${ctx!}/admin/commercial/edit/' + id,
            end: function(index){
    ...
    function add(){
        layer.open({
            ...
            shade: false,
            area: ['693px', '450px'],
            content: '${ctx!}/admin/commercial/add',
            end: function(index){
                $('#table_list').bootstrapTable("refresh");
            }
        });
    ...
    function del(id){
        layer.confirm('确定删除吗?', {icon: 3, title:'提示'}, function(index){
            $.ajax({
                type: "POST",
                dataType: "json",
                url: "${ctx!}/admin/commercial/delete/" + id,
