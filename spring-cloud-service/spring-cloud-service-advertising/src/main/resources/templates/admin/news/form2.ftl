        ...
        <div class="col-sm-12">
            <div class="ibox float-e-margins">
                ...
                <div class="ibox-content">
                    <form class="form-horizontal m-t" id="frm" method="post" action="${ctx!}/admin/news/edit2">
                        <input type="hidden" id="news_id" name="news_id" value="${news.news_id}">
                        <input type="hidden" id="news_type" name="news_type" value="2">
